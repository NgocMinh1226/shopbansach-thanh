...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $truyen = Truyen::orderBy('id','DESC')->where('kichhoat',0)->simplePaginate(9);
    ...
    public function timkiem(){
        $danhmuc = DanhmucTruyen::orderBy('id','DESC')->get();
        $tukhoa = $_GET['tukhoa'];
        $truyen = Truyen::with('danhmuctruyen',)->where('tentruyen','LIKE','%'.$tukhoa.'%')->orWhere('tacgia','LIKE','%'.$tukhoa.'%')->simplePaginate(9);
